...
namespace Packages.realityflow_package.Runtime.scripts.Messages.ProjectMessages
{
    ...
    public class DeleteProject_Received : ConfirmationMessage_Received
    {
        ...
        public delegate void DeleteProjectReceived_EventHandler(object sender, ConfirmationMessageEventArgs eventArgs);

        // The object that handles publishing/subscribing
        private static DeleteProjectReceived_EventHandler _ReceivedEvent;
        public static event DeleteProjectReceived_EventHandler ReceivedEvent
        {
            add
            {
